...
the report without promising a fixed response or release timeline. Credit and
disclosure timing will be coordinated with the reporter when practical.

Vulnerabilities in upstream PSF Requests that are not specific to this rewrite
should be reported under the
[upstream security policy](https://github.com/psf/requests/security/policy).
